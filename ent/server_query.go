...
func (_q *ServerQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ServerQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *ServerQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ServerQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *ServerQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *ServerQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ServerQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(server.Table, server.Columns, sqlgraph.NewFieldSpec(server.FieldID, field.TypeInt64))
	_spec.From = _q.sql
