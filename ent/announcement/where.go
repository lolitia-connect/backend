...
func Show(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldEQ(FieldShow, v))
}

// Pinned applies equality check predicate on the "pinned" field. It's identical to PinnedEQ.
func Pinned(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldEQ(FieldPinned, v))
}

// Popup applies equality check predicate on the "popup" field. It's identical to PopupEQ.
func Popup(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldEQ(FieldPopup, v))
}
...
func ShowEQ(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldEQ(FieldShow, v))
}

// ShowNEQ applies the NEQ predicate on the "show" field.
func ShowNEQ(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldNEQ(FieldShow, v))
}

// PinnedEQ applies the EQ predicate on the "pinned" field.
func PinnedEQ(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldEQ(FieldPinned, v))
}

// PinnedNEQ applies the NEQ predicate on the "pinned" field.
func PinnedNEQ(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldNEQ(FieldPinned, v))
}

// PopupEQ applies the EQ predicate on the "popup" field.
func PopupEQ(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldEQ(FieldPopup, v))
}

// PopupNEQ applies the NEQ predicate on the "popup" field.
func PopupNEQ(v bool) predicate.Announcement {
	return predicate.Announcement(sql.FieldNEQ(FieldPopup, v))
}
