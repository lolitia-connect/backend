...
func (_q *NodeQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *NodeQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *NodeQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *NodeQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *NodeQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *NodeQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *NodeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(node.Table, node.Columns, sqlgraph.NewFieldSpec(node.FieldID, field.TypeInt64))
	_spec.From = _q.sql
