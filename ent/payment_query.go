...
func (_q *PaymentQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PaymentQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *PaymentQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PaymentQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *PaymentQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *PaymentQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
