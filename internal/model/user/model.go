...
type customUserLogicModel interface {
	...
	FindUserSubscribesWithNodeGroup(ctx context.Context) ([]*Subscribe, error)
	FindUserSubscribesByUserAndStatus(ctx context.Context, userId int64, status ...int64) ([]*Subscribe, error)
	FindUnlockedUserSubscribesByStatus(ctx context.Context, status ...int64) ([]*Subscribe, error)
	FindUnlockedUserSubscribesStatusNotIn(ctx context.Context, status ...int64) ([]*Subscribe, error)
	UpdateUserSubscribeNodeGroup(ctx context.Context, id, nodeGroupId int64) error
	...
	CountUserAuthMethods(ctx context.Context, userId int64) (int64, error)
	FindFirstUserAuthMethodByTypes(ctx context.Context, userId int64, authTypes ...string) (*AuthMethods, error)
	...
	FindMaxDeviceOnlineSeconds(ctx context.Context, userId int64) (int64, error)
	FindMaxDeviceDurationDays(ctx context.Context, userId int64) (int64, error)
	FindDeviceOnlineRecordsSince(ctx context.Context, userId int64, since time.Time) ([]*DeviceOnlineRecord, error)
