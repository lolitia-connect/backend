...
func (_q *DocumentQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *DocumentQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *DocumentQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *DocumentQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *DocumentQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *DocumentQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *DocumentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(document.Table, document.Columns, sqlgraph.NewFieldSpec(document.FieldID, field.TypeInt64))
	_spec.From = _q.sql
