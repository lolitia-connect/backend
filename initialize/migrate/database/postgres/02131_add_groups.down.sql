...
DROP INDEX IF EXISTS "idx_subscribe_node_group_id";
...
DROP INDEX IF EXISTS "idx_user_subscribe_node_group_id";
ALTER TABLE "user_subscribe" DROP COLUMN IF EXISTS "group_locked";
